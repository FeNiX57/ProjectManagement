...
// configuration step. It creates a namespace called `ProjectManagement`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", ProjectManagement::cmake::project_name, ProjectManagement::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", ProjectManagement::cmake::project_version);
      return EXIT_SUCCESS;
    }
